...
Feature requests, bugs, support requests, and milestones are tracked via the [BLT JSLINT GitHub issue queue](https://github.com/nikunjkotecha/blt-jslint/issues).
